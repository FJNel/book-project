    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="threeAddBookTypeForm">
                    <div class="mb-3"><label class="form-label" for="threeEdtBookTypeName"><strong>Book Type Name</strong></label><label class="form-label text-danger" for="threeEdtBookTypeName"><strong>*</strong></label><i class="bi bi-info-circle text-muted ms-1" data-bs-toggle="tooltip" data-bss-tooltip="" title="Enter a clear name for this book type, such as Hardcover or Softcover."></i><input class="form-control" type="text" id="threeEdtBookTypeName" name="bookTypeName" autocomplete="off" required="" minlength="2" maxlength="100"><small class="form-text" id="threeBookTypeNameHelp"></small></div>
                    <div class="mb-0"><label class="form-label" for="threeRdtBookTypeDescription"><strong>Description</strong></label><i class="bi bi-info-circle text-muted ms-1" data-bs-toggle="tooltip" data-bss-tooltip="" title="Describe the physical format and any special notes for this book type."></i><textarea class="form-control" id="threeRdtBookTypeDescription" name="bookTypeDescription" autocomplete="off" spellcheck="true" minlength="2" maxlength="500"></textarea><small class="form-text" id="threeBookTypeDescriptionHelp"></small></div>
        </form>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form id="fourAddAuthorForm">
                    <div class="mb-3"><label class="form-label" for="fourEdtAuthorDisplayName"><strong>Display Name</strong></label><label class="form-label text-danger" for="fourEdtAuthorDisplayName"><strong>*</strong></label><i class="bi bi-info-circle text-muted ms-1" data-bs-toggle="tooltip" data-bss-tooltip="" title="The name shown in your collection (for example, a pen name or organization)."></i><input class="form-control" type="text" id="fourEdtAuthorDisplayName" name="authorDisplayName" autocomplete="off" required="" minlength="2" maxlength="150"><small class="form-text" id="fourAuthorDisplayNameHelp"></small></div>
          <div class="row">
