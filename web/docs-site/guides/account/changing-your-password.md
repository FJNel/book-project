# Change your Book Project password
...
You may want to change your password in the following situations:
- You suspect that your password has been compromised or shared with someone else.
- You want to improve the security of your account by using a stronger password.
- You want to update your password periodically as a best practice.
...
After you change your password, you will receive a confirmation message on the website indicating that your password has been successfully changed. Additionally, for security reasons, a notification email will be sent to your registered email address informing you of the password change. You will need to log in again using your new password on all devices and sessions. Make sure to remember your new password, as you will need it for future logins.

### I didn't receive the password change notification email. What should I do?
...
### Will changing my password affect my books or data?
