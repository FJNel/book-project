...
Changing the email address associated with your Book Project account is a supported feature that allows you to update your contact information while ensuring the security and integrity of your account.

## Why would I want to change my email address?

You may want to change your email address for several reasons, including:
- You prefer to use a different email address for your Book Project account.
- You want to consolidate your online accounts under a single email address.
- You have changed your primary email address and want to keep your Book Project account up to date.
- You used the wrong email address when creating your account and need to correct it.
...
> To prevent malicious actors from hijacking accounts, the system does not indicate whether the new email address is valid or not when requesting an email change: You will simply not receive a verification email if the address is already registered to another account. In this case, you may want to try again with a different email address that is not already in use.

> To enhance security and prevent abuse, email change requests are limited. If you exceed the allowed number of requests in a given time period, you may need to wait before trying again.
...
For security reasons, changing your email address will send a notification email to both your old and new email addresses.

## Questions

### Why would I need to change my email address?
Changing your email address allows you to keep your account information up to date and use a preferred email address. It also helps ensure that you receive important notifications and communications related to your Book Project account.

### Do I need my current password to change my email address?
...
### Can I still log in while my new email address is pending confirmation?
Yes, you can continue to log in to your Book Project account using your current email address and password while your new email address is pending confirmation. Your account will remain active and accessible until you complete the email change confirmation process. If you do not confirm the email change using the link sent to your new email address, your email address will remain unchanged.

### Which email address will receive notifications during the email change process?
The current email address associated with your account will continue to receive notifications until you complete the email change confirmation process. The new email address will only start receiving notifications after you have successfully confirmed the change. Both your old and new email addresses will receive notification emails about the change for security purposes.

### What happens if I never confirm the email change?
If you never confirm the email change using the link sent to your new email address, your email address will remain unchanged. You will continue to use your current email address to log in and receive notifications. The email change request will eventually expire, and you may need to initiate a new request if you still wish to change your email address in the future.

### Can I use Google sign-in to change my email address?
...
### What happens after I change my email address?
After you change your email address, you will receive a confirmation message on the website indicating that your email address has been successfully changed. Additionally, for security reasons, notification emails will be sent to both your old and new email addresses informing you of the email address change. You will need to log in again using your new email address on all devices and sessions. Make sure to remember your new email address, as you will need it for future logins.

### I did not receive the email change request email after requesting one. What should I do?
...
- Double-check that you entered the correct new email address when requesting the email change.
- **The new email address you entered is already associated with an existing account:** In this case, you will not receive a new verification email.
